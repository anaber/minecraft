var UnminedCustomMarkers = {
    ...
    markers: [
        ...
        { x: -51, z: -2918, title: "Start of Tunnel to Ancient City", description: "Y: -49", image: "icons/marker-icon.png" },
        { x: 600, z: -2918, title: "Ancient City One", description: "Y: -51", image: "icons/marker-icon.png" },
        { x: -51, z: -2000, title: "Long Tunnel Start", description: "Y: -49", image: "icons/tunnel.png" },
        { x: 1177, z: -3020, title: "Ancient City Two</br>Water Elevator", description: "Y: 111", image: "icons/base.png" },
        { x: 1191, z: -2962, title: "Ancient City Two - Nether Portal", description: "Y: -51", image: "icons/marker-icon.png" },
        { x: -43, z: -1950, title: "Bad Lands Edge Base", description: "Y: 96", image: "icons/base.png" },
        { x: -716, z: -1984, title: "Dead Desert Village", description: "Y: 73", image: "icons/marker-icon.png" },
        { x: 1366, z: -2073, title: "Unknown Village", description: "Y: 94", image: "icons/marker-icon.png" },
